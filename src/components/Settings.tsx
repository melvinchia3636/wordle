...
function Settings({
  ...
  return (
    <div className={`w-full h-screen absolute top-0 left-0 flex flex-col items-center py-12 bg-zinc-100 dark:bg-neutral-800 px-64 tutorial ${showSettings ? 'opacity-100 translate-y-0 z-0 in' : 'opacity-0 translate-y-[30%] z-[-1] out'}`}>
      ...
      <div className={`p-4 px-8 bg-neutral-200 dark:bg-neutral-700 font-medium rounded-md shadow-md text-neutral-600 dark:text-neutral-100 absolute z-10 top-6 left-1/2 -translate-x-1/2 flex items-center transition-transform duration-500 gap-2 ${warning ? 'translate-y-0' : '-translate-y-[150%]'}`}>
