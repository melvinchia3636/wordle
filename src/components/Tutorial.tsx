...
function Tutorial({ showTutorial, setShowTutorial, highContrast }: {
  ...
  return (
    <div className={`w-full h-screen absolute top-0 left-0 flex flex-col items-center justify-center bg-zinc-100 dark:bg-neutral-800 px-24 tutorial ${showTutorial ? 'opacity-100 translate-y-0 z-0 in' : 'opacity-0 translate-y-[30%] z-[-1] out'}`}>
